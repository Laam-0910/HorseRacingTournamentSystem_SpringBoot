...
const CONFIG_DESC_MAP: Record<string, string> = {
  ...
  DEFAULT_JOCKEY_HIRE_FEE: "Default hire fee paid by horse owner to jockey per accepted mount in VNĐ (e.g. 500000)",
  MIN_TICKET_PRICE: "Minimum allowed ticket price for a Race Meeting in VNĐ (e.g. 10000)",
  MAX_TICKET_PRICE: "Maximum allowed ticket price for a Race Meeting in VNĐ (e.g. 5000000)",
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
              {configs
                .filter((c) => {
                  ...
                  // Ẩn ô PAYOS_PAYOUT_API_KEY khi không ở LIVE Mode HOẶC khi AUTO_DISBURSEMENT_ENABLED = FALSE
                  if (c.configKey === "PAYOS_PAYOUT_API_KEY" && (!isLiveMode || !isAutoDisbursement)) {
                    return false;
                  }

                  // Chỉ hiển thị các dòng PayOS Deposit Key khi PAYMENT_GATEWAY_MODE được chọn là LIVE
