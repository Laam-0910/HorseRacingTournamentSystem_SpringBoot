            ...
            <div style={{ display: "flex", alignItems: "center", gap: "1.5rem", fontSize: "0.7rem", fontFamily: "monospace", color: "#a0a0a0" }}>
              ...
              {user ? (
                <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", paddingLeft: "1rem" }}>
                  {/* Uiverse.io (icochran10) Floating Notification & Quick Action Accordion */}
                  <div className="relative z-50">
                    <div className="flex items-center gap-1.5">
                      {/* Accordion Item 1: Notifications */}
                      <div className="group relative">
                        <li className="list-none group/item w-9 overflow-hidden rounded-xl border border-amber-500/30 bg-[#181613]/90 backdrop-blur-md transition-all duration-500 hover:w-64 hover:border-amber-500/60 hover:shadow-2xl shadow-black/80">
                          <button
                            onClick={() => setShowNotifications(v => !v)}
                            className="peer flex w-full cursor-pointer items-center gap-2 px-2 py-1.5 text-left text-amber-400 active:scale-95"
                          >
                          ...
                          <div className="grid grid-rows-[0fr] overflow-hidden transition-all duration-500 peer-focus:grid-rows-[1fr] group-hover/item:grid-rows-[1fr]">
                            <div className="overflow-hidden">
                              <div className="p-3 pt-1 border-t border-white/10 max-h-60 overflow-y-auto space-y-2">
                      ...
                      <div className="group relative">
                        <li className="list-none group/item w-9 overflow-hidden rounded-xl border border-white/10 bg-[#181613]/90 backdrop-blur-md transition-all duration-500 hover:w-56 hover:border-amber-500/60 hover:shadow-2xl shadow-black/80">
                          <button
                            className="peer flex w-full cursor-pointer items-center gap-2 px-2 py-1.5 text-left text-amber-300 active:scale-95"
                          >
                            <div className="rounded-lg border border-amber-500/30 bg-amber-500/10 p-1 flex-shrink-0">
                              <svg className="w-4 h-4" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" fill="none">
                            ...
                            <div className="font-semibold text-xs font-mono text-white truncate pr-1">Quick Links</div>
                          </button>
                          <div className="grid grid-rows-[0fr] overflow-hidden transition-all duration-500 peer-focus:grid-rows-[1fr] group-hover/item:grid-rows-[1fr]">
                            <div className="overflow-hidden">
                              <ul className="divide-y divide-white/5 p-3 pt-1 text-xs font-mono text-white/80">
                                <li onClick={() => navigate('/dashboard')} className="py-1.5 flex items-center justify-between cursor-pointer hover:text-amber-400 transition">
                                  <span>Dashboard</span>
                                  <span className="text-amber-400">➔</span>
                                </li>
                                <li onClick={() => navigate('/livestream')} className="py-1.5 flex items-center justify-between cursor-pointer hover:text-amber-400 transition">
