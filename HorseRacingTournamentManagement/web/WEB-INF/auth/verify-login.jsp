...
<t:layout>
    <jsp:attribute name="pageTitle">Verify Login - Horse Race Management</jsp:attribute>
    <jsp:body>
            ...
            <div class="w-full max-w-md">
              <div class="flex items-center justify-center gap-3 mb-8">
                ...
                <div>
                  ...
                  <p class="text-muted-foreground text-xs font-mono uppercase tracking-widest">2-Step Login</p>
                </div>
              </div>
